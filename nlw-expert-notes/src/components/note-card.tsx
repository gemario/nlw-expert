  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 outline-none max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col">
